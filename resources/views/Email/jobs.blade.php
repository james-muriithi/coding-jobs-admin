...
<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#C0DEED; -webkit-text-size-adjust:none;">
                    ...
                    <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://res.cloudinary.com/james-m/image/upload/v1610038266/free_white_blue_qtdira.jpg" alt="" width="650" height="140" border="0"></td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#dde8fd">
                                        <tr>
                                            <td class="p0-15" style="padding: 10px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2-center" style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:20px;">
                                                            <multiline>New Jobs</multiline>
                                                        </td>
                                                    </tr>
                                                    @if(isset($jobs))
                                                        @foreach($jobs as $job)
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://res.cloudinary.com/james-m/image/upload/a_vflip/a_0/v1610038266/free_white_blue_qtdira.jpg" alt="" width="650" height="130" border="0"></td>
                            </tr>
                            <tr>
                                <td class="p30-15-0" bgcolor="#ffffff" style="border-radius: 0px 0px; padding: 0px 30px 0px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="m-padder2 pb30" align="center" style="padding-bottom:10px;">
                                        ...
                                        <tr>
                                            <td align="center" class="p30-15" style="border-top: 1px solid #ebebeb; padding-top: 30px;">
                                                <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                                    <tr>
                                                        <td class="text-footer2 p30-15" style="color:#8f9fd6; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
                                                            <multiline>© {{ date('Y') }} {{ config('app.name') }}. @lang('All rights reserved.')</multiline>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://res.cloudinary.com/james-m/image/upload/v1610038266/free_white_blue_qtdira.jpg" alt="" width="650" height="130" border="0"></td>
                            </tr>
                            <tr>
