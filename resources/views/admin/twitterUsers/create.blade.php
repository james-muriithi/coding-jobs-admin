...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.twitterUser.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.twitter-users.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('screen_name') ? 'is-invalid' : '' }}" type="text" name="screen_name" id="screen_name" value="{{ old('screen_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_id_str') ? 'is-invalid' : '' }}" type="text" name="user_id_str" id="user_id_str" value="{{ old('user_id_str', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subscribed') ? 'is-invalid' : '' }}" type="number" name="subscribed" id="subscribed" value="{{ old('subscribed', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preference') ? 'is-invalid' : '' }}" type="text" name="preference" id="preference" value="{{ old('preference', 'email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profile_image_url') ? 'is-invalid' : '' }}" type="text" name="profile_image_url" id="profile_image_url" value="{{ old('profile_image_url', '') }}">
